...
public class TreeNode {
    ...
    private final ConcurrentLinkedQueue<Packet> recvPackets = new ConcurrentLinkedQueue<>();
    private final ConcurrentLinkedQueue<Packet> packetsToSend = new ConcurrentLinkedQueue<>();
    private final ConcurrentLinkedQueue<Packet> savedPacketsToSend = new ConcurrentLinkedQueue<>();
    private final ConcurrentHashMap<InetSocketAddress, Long> relatives = new ConcurrentHashMap<>();
